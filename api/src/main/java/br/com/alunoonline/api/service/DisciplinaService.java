...
public class DisciplinaService {
    ...
    public void atualizarDisciplina(Long id, Disciplina disciplinaAtualizada){
        ...
        if (disciplinaDoBancoDeDados.isEmpty()){
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Disciplina não encontrando no banco de dados");
        }
        Disciplina disciplinaParaEditar = disciplinaDoBancoDeDados.get();
        disciplinaParaEditar.setNomeDisciplina(disciplinaAtualizada.getNomeDisciplina());
