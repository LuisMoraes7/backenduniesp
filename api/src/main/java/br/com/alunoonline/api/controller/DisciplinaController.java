...
public class DisciplinaController {
    ...
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void atualizarDisciplina(@PathVariable Long id, @RequestBody Disciplina disciplinaAtualizado){
        disciplinaService.atualizarDisciplina(id, disciplinaAtualizado);
    }
